...
import classes from './ExchangeWidget.module.css';
...
export const ExchangeWidget = ({
  ...
  const isSameCurrencySameAccount =
    toCurrency?.slug === fromCurrency?.slug && toAccountId === fromAccountId;

  const isBothFiatSameAccount =
    fromCurrency?.type === 'FIAT' &&
    toCurrency?.type === 'FIAT' &&
    fromAccountId === toAccountId;

  const isExchangeBlocked = isSameCurrencySameAccount || isBothFiatSameAccount;
  ...
  const isDisabled = useMemo(() => {
    ...
    return isZeroAmount || isExchangeBlocked || !isBalanceSufficient;
  }, [fromAmount, toAmount, isBalanceSufficient, isExchangeBlocked]);
